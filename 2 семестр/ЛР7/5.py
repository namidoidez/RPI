...
ticket1 = Ticket(time.localtime(), "Petr Ivanov", time.strptime("17.12.2017", "%d.%m.%Y"))
# Вызов метода
ticket1.display()
...
setattr(ticket1, "owner", "Ivan Petrov")  # Установка значения атрибута
...
print("Объект time, созданный по заданному времени: ", specified_time)